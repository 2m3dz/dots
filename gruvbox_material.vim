  ...
  if a:background ==# 'hard' "{{{
    if &background ==# 'dark'
      let palette1 = {
            ...
            \ 'bg4':              ['#655E5B',   '237'],
            \ 'bg5':              ['#9C8778',   '239'],
            \ 'bg_statusline1':   ['#0F1718',   '235'],
            \ 'bg_statusline2':   ['#e0c1ac',   '235'],
            \ 'bg_statusline3':   ['#9c8778',   '239'],
            \ 'bg_diff_green':    ['#282C2F',   '22'],
            \ 'bg_visual_green':  ['#3C4347',   '22'],
            \ 'bg_diff_red':      ['#4C4F52',   '52'],
            \ 'bg_visual_red':    ['#655E5B',   '52'],
            \ 'bg_diff_blue':     ['#9C8778',   '17'],
            \ 'bg_visual_blue':   ['#9C8778',   '17'],
            \ 'bg_visual_yellow': ['#e0c1ac',   '94'],
            \ 'bg_current_word':  ['#e0c1ac',   '236']
            \ }
    else
      let palette1 = {
            \ 'bg0':              ['#f9f5d7',   '230'],
